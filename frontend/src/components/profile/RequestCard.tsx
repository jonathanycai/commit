            ...
            <div className="relative rounded-2xl">
                ...
                {showNavigation && (
                    <>
                        <button
                            onClick={onPrevious}
                            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 w-9 h-9 rounded-full flex items-center justify-center z-30"
                        ...
                        <button
                            onClick={onNext}
                            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-9 h-9 rounded-full flex items-center justify-center z-30"
                            style={{ backgroundColor: '#5B7FFF' }}
                        >
